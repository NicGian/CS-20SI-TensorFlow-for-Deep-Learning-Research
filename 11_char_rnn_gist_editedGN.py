...
DATA_PATH = '/home/cuda/Desktop/tf_lesson/data/arxiv_abstracts.txt'
HIDDEN_SIZE = 200
BATCH_SIZE = 64
NUM_STEPS = 50
SKIP_STEP = 40
...
def create_rnn(seq, hidden_size=HIDDEN_SIZE):
    #cell = tf.nn.rnn_cell.GRUCell(hidden_size) #TF 0.12
    cell = tf.contrib.rnn.GRUCell(hidden_size)  #TF 1.0
